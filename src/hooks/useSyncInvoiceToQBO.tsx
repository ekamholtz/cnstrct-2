...
import { QBOService } from '@/integrations/qbo/qboServiceProxy';
 ...
 * This implementation uses direct proxy calls to avoid CORS issues
 */
export const useSyncInvoiceToQBO = () => {
  ...
  const syncInvoiceToQBO = async (invoiceId: string) => {
    ...
    try {
      ...
      // Map invoice data to QBO invoice format
  ...
  return { syncInvoiceToQBO, isLoading };
};
